...
<div id="pop-oubli" class="w100p h100v-80 <?php if($mailOubli == 0) echo "d-none "; ?>flex j-center a-center">
    <div>
        ...
        ?>
        <form action="index.php?controleur=renvoyer_token" method="POST" class="mt32">
            <div>
        ...
        <div class="w200 flex j-between mt32 a-center">
            <a href="index.php"><button class="white back-green btnPad radius5 b-none">Annuler</button></a>
            <a href="index.php?controleur=afficher_page_creation"><button class="white back-green btnPad radius5 b-none">Créer un compte</button></a>
        </div>
    </div>
</div>