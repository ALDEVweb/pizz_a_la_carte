    ...
    <main class="w300 mrlauto h100v-80 flex a-center j-center">
        <div>
            <?php 
                ...
                if($echec == 1) echo "<a href='index.php?controleur=renvoyer_verif&idUtilisateur=$idUtilisateur'><p class='w200 vert fs12 txt-center mb32'>Le lien de vérification à expiré.<br>Clic <b>ici</b> pour recevoir un nouveau lien de vérification</p></a>";
                if($renvoi == 1) echo "<p class='w200 vert fs12 txt-center mb32'>Un e-mail de vérification t'a été envoyé.</p>";
                if($inactif == 1) echo "<a href='index.php?controleur=renvoyer_verif&idUtilisateur=$idUtilisateur'><p class='w200 vert fs12 txt-center mb32'>Ton compte est inactif.<br>Clic <b>ici</b> pour recevoir un lien de vérification et le réactiver.</p></a>";
            ...
            <div class="flex j-center mt32"><a href="index.php?controleur=afficher_page_creation"><button class="white back-green btnPad radius5 b-none">Créer un compte</button></a></div>
        </div>
    </main>
