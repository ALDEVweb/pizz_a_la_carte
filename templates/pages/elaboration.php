    ...
    <main>
        ...
        <section class="w300 mrlauto">
            <div class="w100p flex j-between mt16 a-center">
                <a href="index.php?controleur=reinitialiser"><button id="raz" class="white back-green btnPad radius5 b-none">Réinitialiser</button></a>
                <p id="prixDirect"><b>Prix : - €</b></p>
                <a href="index.php?controleur=valider"><button id="valide" class="white back-green btnPad radius5 b-none">Valider</button></a>
            </div>
        </section>
