...
// parametre : $idOption : id de l'option concerné
//              idUser - id de l'utilisateur connecté
//              categorie - categorie de l'option
//              idPizzElab - id de la pizza en cours d'elaboration 
//              action - action a effectuer sur l'option - ajout-suppression
